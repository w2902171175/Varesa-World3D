...
export function batchStatic(group){
  ...
  group.traverse(o=>{
    ...
    if((o.isMesh||o.isLineSegments)&&!Array.isArray(o.material)&&!o.isInstancedMesh){
      ...
      const b=bins.get(key),geo=o.geometry.clone();geo.applyMatrix4(o.matrixWorld);geo.applyMatrix4(inverseGroup);b.geos.push(geo);b.cast ||=o.castShadow;b.receive ||=o.receiveShadow;originals.push(o);
    }
  });
